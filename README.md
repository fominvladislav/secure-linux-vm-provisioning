...
Дополнительно репозиторий содержит read-only Python-скрипт для автоматизированной приемочной проверки развернутой VM.
...
Все домены, IP-адреса, hostnames и учетные данные в примерах являются тестовыми.
